...
public class KnnReducer {
	...
	private static int numberOfPartition;
	private static int dimension;
	private static int blockSize;
	private static int knn;
	private static Configuration jobinfo;
	public KnnReducer(){
		
	}
	
	public static void KnnConfigure( JobConf job ){
	...
	public static void KnnReduce(Text key, Iterator<MapOutput> values,
