 ...
 */
public class KNNStep1 extends Configured implements Tool 
{
	...
	public int run(String[] args) throws Exception 
	{
		...
		JobConf conf = new JobConf(getConf(), KNNStep1.class);
		conf.setJobName("KNNStep1");

		conf.setMapperClass(MapClass.class);        
		conf.setReducerClass(Reduce.class);
		conf.setOutputKeyClass(IntWritable.class);
		conf.setOutputValueClass(KNNStep1Val.class);
